...
const circleThree = new Circle(350, 30, 40, 'yellow'); // 인스턴스 만들기
const circleFour = new Circle(500, 270, 80, 'darkgreen'); // 인스턴스 만들기
const circleFive = new Circle(550, 80, 50, 'gray'); // 인스턴스 만들기
circleOne.draw();
circleTwo.draw();
circleThree.draw();
circleFour.draw();
